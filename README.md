...
🚀 Desenvolvedor Web em formação com foco em Java e Spring Boot para construção de microsserviços escaláveis e eficientes.

💼 Experiência em projetos colaborativos utilizando Oracle SQL, Docker, e práticas ágeis.

📚 Atualmente estudando Sistemas de Informação na FIAP (7º semestre/8).
